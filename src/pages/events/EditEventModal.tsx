...
import type { EditEventModalProps } from '../../types/event';
...
const EditEventModal: React.FC<EditEventModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.location || !formData.eventDate || !formData.postedById || !event) {
    ...
    try {
      await eventService.update(event.id, formData as EventRequest);
      onEventUpdated();
      handleClose();
    } catch (err: any) {
      ...
      <DialogPositioner>
        <DialogContent maxW="lg" bg="gray.900" borderColor="gray.700">
          <form onSubmit={handleSubmit}>
            <DialogHeader>
              <DialogTitle color="white">Edit Event</DialogTitle>
            </DialogHeader>
